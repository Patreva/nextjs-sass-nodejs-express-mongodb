...
const BlogsPage = (props) => {
  ...
  return (
    <Layout>
      <Head>
        <title>Nutrition | {APP_NAME}</title>
        <meta
          name="description"
          content="Untapped Nutrition blogs that provides alot of useful nutrition information"
        />

        <link rel="canonical" href={`${DOMAIN}${router.pathname}`} />
        <meta
          property="og:title"
          content={`Latest nutrition blogs | ${APP_NAME}`}
        />
        <meta
